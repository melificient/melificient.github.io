...
The conversational AI session opened with [**Dilek Hakkani-Tür**](https://dilek.web.illinois.edu/) (University of Illinois Urbana-Champaign) on over-reliance. She described how users tend to accept the outputs of fluent systems uncritically, contributing to an accountability gap, and argued that dialogue systems should include built-in uncertainty expression and explicit deferral mechanisms.

[**Mirco Ravanelli**](https://sites.google.com/site/mircoravanelli/) (Concordia University, Mila) presented work on discrete audio tokens for multimodal LLMs, which allow models to process speech and audio in a manner comparable to text.

[**Roland Memisevic**](https://www-labs.iro.umontreal.ca/~memisevr/) (Qualcomm AI Research, Toronto) closed the session with work on end-to-end learning for camera-based situated interaction, and discussed the role of embodied understanding in the next generation of AI assistants.
...
[**Saif Mohammad**](https://www.saifmohammad.com/) (National Research Council Canada) spoke on NLP for affective science, examining which questions about emotion, sentiment, and subjective experience can be productively investigated with current tools.
...
[**Géraldine Damnati**](https://sites.google.com/site/geraldinedamnati/) (Orange Innovation) closed the workshop with a discussion of the need to move from benchmark assessments to in-use evaluation. She argued that the gap between model performance on curated test sets and model behavior in real deployments has grown in the generative-AI era.
