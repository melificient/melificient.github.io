...
<details style="margin: 1rem 0; border: 1px solid #e1e4e8; border-radius: 8px; padding: 0.75rem 1rem; background: #f6f8fa; font-size: 0.85rem;">
  ...
  <ol style="padding-left: 1.25rem; margin: 0.75rem 0 0.25rem 0; line-height: 1.5;">
    ...
    <li>Claire Gardent, CNRS/LORIA, Nancy, Data-to-text across languages</li>
    <li>Philippe Langlais, Université de Montréal, Rethinking evaluation</li>
    <li>Golnoosh Farnadi, McGill University &amp; Mila, Fairness in foundation models</li>
    <li>François Yvon, CNRS, Paris, Translation memories</li>
    ...
    <li>Lili Mou, University of Alberta, LLMs as reward signals</li>
  </ol>
</details>
...
<details style="margin: 1rem 0; border: 1px solid #e1e4e8; border-radius: 8px; padding: 0.75rem 1rem; background: #f6f8fa; font-size: 0.85rem;">
  ...
  <ol style="padding-left: 1.25rem; margin: 0.75rem 0 0.25rem 0; line-height: 1.5;">
    ...
    <li>Abdellah Fourtassi, LIS, Marseille, How children learn language</li>
    <li>Guillaume Dumas, Université de Montréal/Mila, Brains vs. language models</li>
    <li>Benjamin Morillon, INSERM, INS, Marseille, What LMs reveal about the brain</li>
    <li>Maxime Peyrard, CNRS, LIG Grenoble, and Dhanya Sridhar, Université de Montréal/Mila, Causal models for NLP</li>
...
<details style="margin: 1rem 0; border: 1px solid #e1e4e8; border-radius: 8px; padding: 0.75rem 1rem; background: #f6f8fa; font-size: 0.85rem;">
  ...
  <ol style="padding-left: 1.25rem; margin: 0.75rem 0 0.25rem 0; line-height: 1.5;">
    ...
    <li>Roland Memisevic, Qualcomm, Toronto, Situated interaction</li>
    <li>Serena Villata, CNRS, I3S, Nice, and Jimmy Lin, University of Waterloo, Argumentation and retrieval</li>
    <li>Saif Mohammad, National Research Council Canada, NLP for affective science</li>
    <li>Frank Rudzicz, Dalhousie University, Halifax, Language tech in healthcare</li>
    <li>Géraldine Damnati, Orange Innovation, Lannion, Real-world evaluation</li>
  </ol>
</details>
...
The conversational AI session opened with [**Dilek Hakkani-Tür**](https://dilek.web.illinois.edu/) (University of Illinois, Urbana-Champaign) on [over-reliance](https://arxiv.org/abs/2409.09629), describing how users tend to accept the outputs of fluent systems uncritically, contributing to an accountability gap, and arguing that dialogue systems should include built-in uncertainty expression and explicit deferral mechanisms. [**Mirco Ravanelli**](https://sites.google.com/site/mircoravanelli/) (Concordia University/Mila) presented work on [discrete audio tokens for multimodal LLMs](https://arxiv.org/abs/2406.14294), which allow models to process speech and audio in a manner comparable to text. [**Roland Memisevic**](https://www-labs.iro.umontreal.ca/~memisevr/) (Qualcomm, Toronto) closed the session with work on end-to-end learning for [camera-based situated interaction](https://arxiv.org/abs/2407.08101), and discussed the role of embodied understanding in the next generation of AI assistants.

The information retrieval and argumentation session followed, with [**Serena Villata**](https://webusers.i3s.unice.fr/~villata/Home.html) (CNRS, I3S, Nice) on [trustworthy natural-language argumentation](https://ebooks.iospress.nl/volumearticle/69204), a field she noted is becoming increasingly important as LLMs generate growing volumes of persuasive text online. [**Jimmy Lin**](https://cs.uwaterloo.ca/~jimmylin/) (University of Waterloo) then addressed the future of information retrieval in an LLM-mediated environment, focusing on the evolving question of [how retrieval systems should be evaluated](https://arxiv.org/abs/2406.06519).

[**Saif Mohammad**](https://www.saifmohammad.com/) (National Research Council Canada) reframed emotion recognition as a window on affective science for the application session, presenting work on [emotional granularity](https://aclanthology.org/2024.emnlp-main.1069/), the finding that people whose language shows finer emotional distinctions tend to have better mental and physical health outcomes, and closing with a note of caution against overclaiming what such systems can do. [**Frank Rudzicz**](https://www.dal.ca/faculty/computerscience/faculty-staff/Frank-Rudzicz.html) (Dalhousie University, Halifax) presented a talk entitled "NLPrimum Non Nocere," a reference to the principle of "first, do no harm," which addressed the [risks of deploying language technology in medical and clinical contexts](https://arxiv.org/abs/2412.05533) where errors carry significant consequences. [**Géraldine Damnati**](https://sites.google.com/site/geraldinedamnati/) (Orange Innovation, Lannion) closed the workshop with a discussion of the need to [move from benchmark assessments to in-use evaluation](https://aclanthology.org/2024.humeval-1.6/), noting that the gap between model performance on curated test sets and model behavior in real deployments has grown in the generative-AI era.

### Closing reflections

In hindsight, several themes recurred across sessions. Speakers raised concerns about the reliability of current benchmarks and evaluation practices. Several talks addressed how scale amplifies disparities along linguistic and cultural lines. Presenters working at the intersection of cognitive science and AI cautioned that similar outputs between models and humans do not necessarily indicate similar underlying mechanisms. Researchers on the applied topics emphasized the need for improved evaluation, accountability, and deployment practices.

Consistent with the transatlantic framing of the event, organizers closed with plans to hold a follow-up edition in Paris in the next few years!
