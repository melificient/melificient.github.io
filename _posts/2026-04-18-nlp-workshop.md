...
<details style="margin: 2rem 0; border: 1px solid #e1e4e8; border-radius: 8px; padding: 1rem 1.25rem; background: #f6f8fa;">
  <summary style="cursor: pointer; font-weight: 600; font-size: 1.05rem; padding: 0.25rem 0;">📋 Program overview — click to expand</summary>
  <div style="margin-top: 1rem; display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.25rem;">
    <div>
      <h4 style="margin-top: 0; border-bottom: 2px solid #0366d6; padding-bottom: 0.35rem;">Day 1 · Technical foundations</h4>
      <ol style="padding-left: 1.25rem; margin: 0.5rem 0; line-height: 1.55;">
        <li><a href="#bengio">Yoshua Bengio</a> — Risks of capable AI</li>
        <li><a href="#bzdok">Danilo Bzdok</a> — IVADO and the Canadian AI ecosystem</li>
        <li><a href="#gardent">Claire Gardent</a> — Data-to-text across languages</li>
        <li><a href="#langlais">Philippe Langlais</a> — Rethinking evaluation</li>
        <li><a href="#farnadi">Golnoosh Farnadi</a> — Fairness in foundation models</li>
        <li><a href="#yvon">François Yvon</a> — Translation memories</li>
        <li><a href="#adelani">David Adelani</a> — LLMs for African languages</li>
        <li><a href="#reddy">Siva Reddy</a> — Inductive biases for LLMs</li>
        <li><a href="#sagot">Benoît Sagot</a> — Why small LMs struggle</li>
        <li><a href="#mou">Lili Mou</a> — LLMs as reward signals</li>
      </ol>
    </div>
    <div>
      <h4 style="margin-top: 0; border-bottom: 2px solid #28a745; padding-bottom: 0.35rem;">Day 2 · Cognition &amp; brains</h4>
      <ol style="padding-left: 1.25rem; margin: 0.5rem 0; line-height: 1.55;">
        <li><a href="#xu">Yang Xu</a> — Why languages look the way they do</li>
        <li><a href="#fourtassi">Abdellah Fourtassi</a> — How children learn language</li>
        <li><a href="#dumas">Guillaume Dumas</a> — Brains vs. language models</li>
        <li><a href="#morillon">Benjamin Morillon</a> — What LMs reveal about the brain</li>
        <li><a href="#peyrard-sridhar">Peyrard &amp; Sridhar</a> — Causal models for NLP</li>
        <li><a href="#day2-panel">Panel discussion</a></li>
      </ol>
    </div>
    <div>
      <h4 style="margin-top: 0; border-bottom: 2px solid #d73a49; padding-bottom: 0.35rem;">Day 3 · Society &amp; applications</h4>
      <ol style="padding-left: 1.25rem; margin: 0.5rem 0; line-height: 1.55;">
        <li><a href="#hakkani-tur">Dilek Hakkani-Tür</a> — Friction in dialogue systems</li>
        <li><a href="#ravanelli">Mirco Ravanelli</a> — Audio for multimodal LLMs</li>
        <li><a href="#memisevic">Roland Memisevic</a> — Situated interaction</li>
        <li><a href="#villata-lin">Villata &amp; Lin</a> — Argumentation and retrieval</li>
        <li><a href="#mohammad">Saif Mohammad</a> — NLP for affective science</li>
        <li><a href="#rudzicz">Frank Rudzicz</a> — Language tech in healthcare</li>
        <li><a href="#damnati">Géraldine Damnati</a> — Real-world evaluation</li>
      </ol>
    </div>
  </div>
</details>
...
### Yoshua Bengio (Université de Montréal, Mila): On the Risks of Increasingly Capable AI {#bengio}
...
### Danilo Bzdok (McGill University, Mila): IVADO and the Canadian AI Ecosystem {#bzdok}
...
### Claire Gardent (CNRS, LORIA): Turning Data into Text Across Many Languages {#gardent}
...
### Philippe Langlais (Université de Montréal, RALI): Rethinking How We Measure Progress {#langlais}
...
### Golnoosh Farnadi (McGill University, Mila): Fairness in Foundation Models {#farnadi}
...
### François Yvon (CNRS, ISIR): Translation That Remembers {#yvon}
...
### David Adelani (McGill University, Mila): Making Language Models Work for African Languages {#adelani}
...
### Siva Reddy (McGill University, Mila): Do Language Models Still Need Our Help? {#reddy}
...
### Benoît Sagot (INRIA Almanach, Paris): Why Small Language Models Struggle {#sagot}
...
### Lili Mou (University of Alberta, Amii): Language Models as Hidden Reward Signals {#mou}
...
### Yang Xu (University of Toronto): Why Languages Look the Way They Do {#xu}
...
### Abdellah Fourtassi (Aix-Marseille Université): Using AI to Study How Children Learn Language {#fourtassi}
...
### Guillaume Dumas (Université de Montréal, Mila): The Gap Between Brains and Language Models {#dumas}
...
### Benjamin Morillon (Aix-Marseille Université, INSERM): What Language Models Reveal About the Brain {#morillon}
...
### Maxime Peyrard (CNRS, Grenoble): Can We Really Explain What a Neural Network Is Doing? and Dhanya Sridhar (Université de Montréal, Mila): What Language Models Are Actually Learning From Examples {#peyrard-sridhar}
...
### Dilek Hakkani-Tür (University of Illinois Urbana-Champaign): Why a Little Friction Is a Good Thing {#hakkani-tur}
...
### Mirco Ravanelli (Concordia University, Mila): Teaching Language Models to Handle Audio {#ravanelli}
...
### Roland Memisevic (Qualcomm AI Research, Toronto): Building AI That Watches and Talks Back in Real Time {#memisevic}
...
### Serena Villata (CNRS i3s): Teaching Computers to Recognize Arguments and Jimmy Lin (University of Waterloo): Search as an Aid to Thinking {#villata-lin}
...
### Saif Mohammad (National Research Council Canada): What Language Can Tell Us About Emotions {#mohammad}
...
### Frank Rudzicz (Dalhousie University): Language Technology in Healthcare {#rudzicz}
...
### Géraldine Damnati (Orange Innovation): Evaluation in the Real World {#damnati}
