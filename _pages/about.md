...
Fellow of the [Royal Statistical Society](https://rss.org.uk/) and reviewer for [IEEE-EMBS International Conference on Biomedical and Health Informatics (BHI)](https://bhi.embs.org/), [Medical Informatics Europe (MIE)](https://efmi.org/conferences-journals/mie-confererence/), the [International Conference on Informatics, Management and Technology in Healthcare (ICIMTH)](https://icimth.com/), and the [World Congress on Medical and Health Informatics (MedInfo)](https://imia-medinfo.org/wp/medinfo/).


Lifelong learner active in events, conferences, and workshops, with a particular interest in IVADO's [Thematic Semesters Programs] (https://ivado.ca/en/ivados-thematic-semesters-program/). Currently enrolled in IVADO [LLMOps](https://catalogue.ivado.umontreal.ca/Web/MyCatalog/ViewP?pid=DwpGfXsYFQ5dNLAWEt9mWQ%3d%3d&id=cmUf5sy%2f1hKY2HaR6U0ZJg%3d%3d) course and attending monthly meetings of IVADO's reserach regroupements on [machine learning](https://ivado.ca/en/regroupements/machine-learning/) and [healthcare systems](https://ivado.ca/en/regroupements/healthcare-systems/).
